...
(function () {
  ...
  const more = [
    ...
    // =================================================================
    {
      ...
      description: "Instale o Python, configure seu ambiente e escreva seus primeiros scripts. Aprenda tipos, estruturas de dados (listas, dicionários, sets, tuplas), controle de fluxo, funções, módulos e o essencial da biblioteca padrão. Tudo explicado com contexto, exemplos reais e dicas de estilo (PEP 8). Base sólida para ciência de dados, automação, web e IA.",
      level: "Iniciante",
      duration: "5h",
      theme: "theme-python",
      cover: "Python",
...
<div class="callout"><div class="ico">🏆</div><p>Mandou bem. Próximo passo: o curso Desenvolvedor Python (VIP) para POO, decorators, testes e APIs.</p></div>`,
    ...
    // =================================================================
    {
      ...
      description: "Destrave as partes que separam juniores de seniores em JavaScript: escopo léxico e closures, hoisting, protótipos e a cadeia de herança, classes modernas, promises e async/await, módulos ES e CommonJS, iteradores e generators, proxy, reflect e padrões aplicados. Com exemplos comentados, comparações entre abordagens e quizzes reforçando cada conceito.",
      level: "Intermediário",
      duration: "10h",
      theme: "theme-advjs",
      cover: "JS Avançado",
...
<p>Use a aba Performance do DevTools. Confie em números, não em intuição.</p>`,
    ...
    // =================================================================
    {
      ...
      description: "O caminho completo de script básico a engenheiro Python. Programação orientada a objetos profunda, data classes, protocolos, decorators, generators e comprehensions avançadas, tipagem (type hints + mypy), testes (pytest), empacotamento (pyproject), perfomance e construção de APIs reais com Flask e FastAPI. Inclui seções explicando o “por quê” de cada padrão, não só o “como”.",
      level: "Intermediário",
      duration: "12h",
      theme: "theme-python",
      cover: "PyDev",
...
<div class="callout"><div class="ico">🚀</div><p>Para novas APIs Python em 2025, FastAPI costuma ser o padrão certo.</p></div>`,
    ...
    // =================================================================
    {
      ...
      description: "O mapa completo de um produto web moderno. HTTP do zero, frontends em React com componentes, estado e rotas, backends com Node/Express, design de API REST, bancos relacionais (PostgreSQL) e não relacionais, autenticação com JWT e sessões, testes, Docker, CI/CD e deploy. Cada módulo explica a arquitetura antes de mostrar código — você vai entender onde cada peça se encaixa.",
      level: "Avançado",
      duration: "16h",
...
<div class="callout"><div class="ico">🎓</div><p>Agora você tem o mapa completo. O que resta é continuar entregando.</p></div>`,
    ...
    // =================================================================
    {
      ...
      description: "Design pensando em produto real. Princípios de UX (jobs-to-be-done, heurísticas de Nielsen, pesquisa com usuários), arquitetura da informação, wireframes, protótipos, design visual (tipografia, cor, espaçamento, hierarquia), componentes acessíveis, design tokens e como estruturar e evoluir um design system consistente em múltiplos produtos. Explicações ricas em contexto, exemplos, estudos de caso e exercícios práticos.",
      level: "Intermediário",
      duration: "8h",
      theme: "theme-uiux",
      cover: "UI/UX",
