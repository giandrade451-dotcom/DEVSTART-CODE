...
(function () {
  ...
  const courses = [
    ...
    // =================================================================
    {
      ...
      description: "Aprenda as duas linguagens essenciais da web. Crie páginas acessíveis e organizadas com HTML semântico moderno e estilize tudo com CSS: tipografia, layout com Flexbox e Grid, responsividade, variáveis CSS, animações suaves e boas práticas. Inclui exercícios guiados e um mini-projeto completo ao final para você levar no portfólio.",
      level: "Iniciante",
      duration: "6h",
      theme: "theme-html",
      cover: "HTML/CSS",
...
<div class="callout"><div class="ico">🚀</div><p>Parabéns — você já consegue ler e escrever HTML + CSS. Próximo passo: dar vida às páginas com JavaScript.</p></div>`,
    ...
    // =================================================================
    {
      ...
      description: "Escreva seus primeiros programas em JavaScript do começo ao fim. Variáveis, tipos, funções, arrays, objetos, classes, módulos, DOM, eventos, fetch e erros — com explicações detalhadas, dicas de estilo, exemplos comentados e quizzes em cada aula para fixar tudo. Pensado para quem nunca programou antes.",
      level: "Iniciante",
      duration: "8h",
      theme: "theme-js",
      cover: "JS",
...
<div class="callout"><div class="ico">🎉</div><p>Você acabou de construir um app de tarefas com persistência e sem dependência nenhuma. A seguir: JavaScript avançado (VIP) para subir de nível em closures, async e módulos.</p></div>`,
    ...
    // =================================================================
    {
      ...
      description: "Fundamentos de pensamento computacional: como um computador executa instruções, variáveis, condicionais, laços, funções, recursão, complexidade (big-O na prática) e padrões de resolução de problemas. Independe de linguagem: tudo que você aprender aqui vale para JavaScript, Python, Java e qualquer outra stack que encontrar no caminho.",
      level: "Iniciante",
      duration: "5h",
      theme: "theme-logic",
      cover: "Logic",
